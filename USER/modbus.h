...
BOOL xMBRTUReceiveFSM( UCHAR u8byte ); 

BOOL xMBRTUTransmitFSM( void );

BOOL xMBRTUTimerT35Expired( void );

extern UCHAR RTUTimerT35ExpiredEn;
...
extern u16  DisMesureManual;  //  ÷∂ØºÏ≤‚æ‡¿Î
extern  u16  HysMesureManual;  //  ÷∂ØºÏ≤‚æ‡¿Î
extern u8  ChannelSampleEn; //  channel sample enable   flag 

extern  void ModbusTestcode(void); 
